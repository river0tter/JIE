...
#             new_predictions = func('dev', predictions)
            formatter(new_predictions, out_path = out_path)
...
def main():
    ...
    parser.add_argument('--load_pretrained_model', type=int, default=1, help='whether to load pretrained model')
    parser.add_argument('--make_prediction', type=int, default=1, help='whether to make predictions')
