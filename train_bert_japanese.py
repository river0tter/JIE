...
def main():
    ...
    parser.add_argument('--pretrained_model_path', type=str, default='jap_save/lr_8e-06_pr3_tn10.pt', help='pretrain model name')
    ...
    args.model_dir = 'jap_save_0627'
    if not os.path.isdir(args.model_dir):
        os.makedirs(args.model_dir)

    args.log_dir = 'jap_train_log_0627'
    if not os.path.isdir(args.log_dir):
        os.makedirs(args.log_dir)

    args.output_dir = 'jap_output_0627'
